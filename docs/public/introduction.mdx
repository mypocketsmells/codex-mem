---
title: "Introduction"
description: "Persistent memory compression system for Codex and Claude-style coding workflows"
---

# Codex-Mem

**Persistent memory compression system for Codex and Claude-style coding workflows**

<picture>
  <source media="(prefers-color-scheme: dark)" srcSet="/codex-mem-logo-for-dark-mode.webp" />
  <source media="(prefers-color-scheme: light)" srcSet="/codex-mem-logo-for-light-mode.webp" />
  <img src="/codex-mem-logo-for-light-mode.webp" alt="Codex-Mem logo" style={{ maxWidth: '460px', width: '100%' }} />
</picture>
...
<CardGroup cols={2}>
  ...
  <Card title="Getting Started" icon="rocket" href="/usage/getting-started">
    Learn how Codex-Mem works automatically
  </Card>
