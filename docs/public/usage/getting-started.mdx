...
description: "Learn how Codex-Mem works automatically in the background"
---

# Getting Started with Codex-Mem

## Automatic Operation

Codex-Mem works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, codex-mem captures it:
...
Context is stored in SQLite database at `~/.codex-mem/codex-mem.db`.
...
Codex-Mem supports sessions that span multiple user prompts:
