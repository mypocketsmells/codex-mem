...
Instead of fetching all historical data upfront (expensive), codex-mem uses a progressive disclosure approach:
...
**Database:** SQLite FTS5 full-text search on `~/.codex-mem/codex-mem.db`
