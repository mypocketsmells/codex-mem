...
2. Call: `GET http://localhost:37777/api/context/inject?project={project}`
...
// Removes <private>...</private> and <codex-mem-context>...</codex-mem-context>
...
POST http://localhost:37777/api/sessions/observations
Body: {
...
POST http://localhost:37777/api/sessions/summarize
Body: {
  claudeSessionId: session_id,
...
POST http://localhost:37777/api/processing
...
POST http://localhost:37777/api/sessions/complete
Body: {
  claudeSessionId: session_id,
...
<codex-mem-context>...</codex-mem-context>
```
