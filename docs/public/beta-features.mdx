...
**Your memory data is always preserved.** The database at `~/.codex-mem/codex-mem.db` is not affected by version switching. All your observations, sessions, and summaries remain intact.
...
- Open an issue at [GitHub Issues](https://github.com/thedotmack/codex-mem/issues)
