...
<p align="center">
  Codex-Mem bewahrt nahtlos Kontext über Sitzungen hinweg, indem es automatisch Beobachtungen zur Tool-Nutzung erfasst, semantische Zusammenfassungen generiert und diese für zukünftige Sitzungen verfügbar macht. Dies ermöglicht es Claude, die Kontinuität des Wissens über Projekte aufrechtzuerhalten, auch nachdem Sitzungen beendet wurden oder die Verbindung wiederhergestellt wird.
</p>
...
- **[Installationsanleitung](https://docs.codex-mem.ai/installation)** - Schnellstart & erweiterte Installation
- **[Nutzungsanleitung](https://docs.codex-mem.ai/usage/getting-started)** - Wie Codex-Mem automatisch funktioniert
- **[Suchwerkzeuge](https://docs.codex-mem.ai/usage/search-tools)** - Durchsuchen Sie Ihre Projekthistorie mit natürlicher Sprache
- **[Beta-Funktionen](https://docs.codex-mem.ai/beta-features)** - Probieren Sie experimentelle Funktionen wie den Endless Mode

### Best Practices

- **[Context Engineering](https://docs.codex-mem.ai/context-engineering)** - Prinzipien der Kontextoptimierung für KI-Agenten
- **[Progressive Disclosure](https://docs.codex-mem.ai/progressive-disclosure)** - Philosophie hinter Codex-Mems Kontext-Priming-Strategie

### Architektur

- **[Übersicht](https://docs.codex-mem.ai/architecture/overview)** - Systemkomponenten & Datenfluss
- **[Architekturentwicklung](https://docs.codex-mem.ai/architecture-evolution)** - Die Reise von v3 zu v5
- **[Hooks-Architektur](https://docs.codex-mem.ai/hooks-architecture)** - Wie Codex-Mem Lifecycle-Hooks verwendet
- **[Hooks-Referenz](https://docs.codex-mem.ai/architecture/hooks)** - 7 Hook-Skripte erklärt
- **[Worker Service](https://docs.codex-mem.ai/architecture/worker-service)** - HTTP API & Bun-Verwaltung
- **[Datenbank](https://docs.codex-mem.ai/architecture/database)** - SQLite-Schema & FTS5-Suche
- **[Such-Architektur](https://docs.codex-mem.ai/architecture/search-architecture)** - Hybride Suche mit Chroma-Vektordatenbank

### Konfiguration & Entwicklung

- **[Konfiguration](https://docs.codex-mem.ai/configuration)** - Umgebungsvariablen & Einstellungen
- **[Entwicklung](https://docs.codex-mem.ai/development)** - Erstellen, Testen, Beitragen
- **[Fehlerbehebung](https://docs.codex-mem.ai/troubleshooting)** - Häufige Probleme & Lösungen
...
Siehe [Architekturübersicht](https://docs.codex-mem.ai/architecture/overview) für Details.

---

## mem-search Skill

Codex-Mem bietet intelligente Suche durch den mem-search Skill, der sich automatisch aktiviert, wenn Sie nach früheren Arbeiten fragen:
...
Siehe [Suchwerkzeuge-Anleitung](https://docs.codex-mem.ai/usage/search-tools) für detaillierte Beispiele.

---

## Beta-Funktionen

Codex-Mem bietet einen **Beta-Kanal** mit experimentellen Funktionen wie **Endless Mode** (biomimetische Speicherarchitektur für erweiterte Sitzungen). Wechseln Sie zwischen stabilen und Beta-Versionen über die Web-Viewer-UI unter http://localhost:37777 → Settings.

Siehe **[Beta-Funktionen-Dokumentation](https://docs.codex-mem.ai/beta-features)** für Details zum Endless Mode und wie Sie ihn ausprobieren können.
...
Einstellungen werden in `~/.codex-mem/settings.json` verwaltet (wird beim ersten Start automatisch mit Standardwerten erstellt). Konfigurieren Sie KI-Modell, Worker-Port, Datenverzeichnis, Log-Level und Kontext-Injektionseinstellungen.

Siehe die **[Konfigurationsanleitung](https://docs.codex-mem.ai/configuration)** für alle verfügbaren Einstellungen und Beispiele.

---

## Entwicklung

Siehe die **[Entwicklungsanleitung](https://docs.codex-mem.ai/development)** für Build-Anweisungen, Tests und Beitrags-Workflow.
...
Siehe die **[Fehlerbehebungsanleitung](https://docs.codex-mem.ai/troubleshooting)** für häufige Probleme und Lösungen.
...
Siehe [Entwicklungsanleitung](https://docs.codex-mem.ai/development) für den Beitrags-Workflow.
