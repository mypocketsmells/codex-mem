    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_PROVIDER_FALLBACK_POLICY: data.CLAUDE_MEM_PROVIDER_FALLBACK_POLICY || DEFAULT_SETTINGS.CLAUDE_MEM_PROVIDER_FALLBACK_POLICY,
          CLAUDE_MEM_CODEX_MODEL: data.CLAUDE_MEM_CODEX_MODEL || DEFAULT_SETTINGS.CLAUDE_MEM_CODEX_MODEL,
          CLAUDE_MEM_CODEX_REASONING_EFFORT: data.CLAUDE_MEM_CODEX_REASONING_EFFORT || DEFAULT_SETTINGS.CLAUDE_MEM_CODEX_REASONING_EFFORT,
