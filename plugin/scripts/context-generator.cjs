"use strict";var ht=Object.create;var x=Object.defineProperty;var bt=Object.getOwnPropertyDescriptor;var Ot=Object.getOwnPropertyNames;var Ct=Object.getPrototypeOf,At=Object.prototype.hasOwnProperty;var Rt=(r,e)=>{for(var t in e)x(r,t,{get:e[t],enumerable:!0})},oe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ot(e))!At.call(r,n)&&n!==t&&x(r,n,{get:()=>e[n],enumerable:!(s=bt(e,n))||s.enumerable});return r};var k=(r,e,t)=>(t=r!=null?ht(Ct(r)):{},oe(e||!r||!r.__esModule?x(t,"default",{value:r,enumerable:!0}):t,r)),Mt=r=>oe(x({},"__esModule",{value:!0}),r);var Yt={};Rt(Yt,{generateContext:()=>ne});module.exports=Mt(Yt);var Tt=k(require("path"),1),ft=require("os"),St=require("fs");var be=require("bun:sqlite"),Oe=require("path");var h=require("path"),Ee=require("os"),w=require("fs");var ge=require("url");var A=require("fs"),me=require("path");var ie="bugfix,feature,refactor,discovery,decision,change",ae="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var de=require("fs"),pe=require("os"),W=require("path"),ce=require("child_process"),N="codex-mem",_e=".codex-mem";function Nt(){return(0,W.join)((0,pe.homedir)(),_e)}function yt(r=process.cwd()){try{let e=(0,ce.execSync)("git rev-parse --show-toplevel",{cwd:r,encoding:"utf8",stdio:["pipe","pipe","ignore"],windowsHide:!0}).trim();if(e)return e}catch{}return r}function ue(r=process.cwd()){return(0,W.join)(yt(r),_e)}function U(){if(process.env.CODEX_MEM_DATA_DIR)return process.env.CODEX_MEM_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=Nt();return(0,de.existsSync)(r),r}var y=class{static warnedDeprecationKeys=new Set;static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"localhost",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_PROVIDER:"codex",CLAUDE_MEM_PROVIDER_FALLBACK_POLICY:"auto",CLAUDE_MEM_CODEX_MODEL:"gpt-5",CLAUDE_MEM_CODEX_REASONING_EFFORT:"high",CLAUDE_MEM_CLAUDE_AUTH_METHOD:"cli",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:N,CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_OLLAMA_MODE:"native",CLAUDE_MEM_OLLAMA_BASE_URL:"http://localhost:11434",CLAUDE_MEM_OLLAMA_MODEL:"gemma3:4b",CLAUDE_MEM_OLLAMA_TIMEOUT_MS:"120000",CLAUDE_MEM_OLLAMA_TEMPERATURE:"0.2",CLAUDE_MEM_OLLAMA_NUM_CTX:"8192",CLAUDE_MEM_OLLAMA_OPTIONS_JSON:"{}",CLAUDE_MEM_DATA_DIR:U(),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:ie,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:ae,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static resetDeprecationWarningsForTests(){this.warnedDeprecationKeys.clear()}static loadFromFile(e){try{if(!(0,A.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,me.dirname)(e);(0,A.existsSync)(a)||(0,A.mkdirSync)(a,{recursive:!0}),(0,A.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return this.applyEnvironmentOverrides(i)}let t=(0,A.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,A.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))n[i]!==void 0&&(o[i]=n[i]);return this.applyEnvironmentOverrides(o)}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.applyEnvironmentOverrides(this.getAllDefaults())}}static applyEnvironmentOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS)){let n=process.env[s];if(n!==void 0&&(t[s]=n,s.startsWith("CLAUDE_MEM_"))){let o=`CODEX_MEM_${s.slice(11)}`;this.warnLegacyEnvKeyOnce(s,o)}if(s.startsWith("CLAUDE_MEM_")){let o=`CODEX_MEM_${s.slice(11)}`,i=process.env[o];i!==void 0&&(t[s]=i)}}return process.env.CLAUDE_CODE_PATH!==void 0&&this.warnLegacyEnvKeyOnce("CLAUDE_CODE_PATH","CODEX_CODE_PATH"),process.env.CODEX_CODE_PATH!==void 0&&(t.CLAUDE_CODE_PATH=process.env.CODEX_CODE_PATH),t}static warnLegacyEnvKeyOnce(e,t){this.warnedDeprecationKeys.has(e)||(this.warnedDeprecationKeys.add(e),console.warn(`[SETTINGS] Deprecated environment key ${e} detected. Use ${t} instead. Legacy keys remain supported for now.`))}};var R=require("fs"),$=require("path");var Y=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Y||{}),le=U(),V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,$.join)(le,"logs");(0,R.existsSync)(e)||(0,R.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,$.join)(e,`${N}-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,$.join)(le,"settings.json");if((0,R.existsSync)(e)){let t=(0,R.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Y[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=Y[e].padEnd(5),d=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let u="";o!=null&&(o instanceof Error?u=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?u=`
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:b,...l}=n;Object.keys(l).length>0&&(m=` {${Object.entries(l).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${m}${u}`;if(this.logFilePath)try{(0,R.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},_=new V;var Ut={};function It(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,ge.fileURLToPath)(Ut.url))}var Lt=It(),M=y.get("CLAUDE_MEM_DATA_DIR"),K=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,Ee.homedir)(),".claude"),is=(0,h.join)(M,"archives"),as=(0,h.join)(M,"logs"),ds=(0,h.join)(M,"trash"),ps=(0,h.join)(M,"backups"),cs=(0,h.join)(M,"modes"),Te=(0,h.join)(M,"settings.json"),vt=`${N}.db`;function Dt(){if(process.env.CODEX_MEM_DATA_DIR)return process.env.CODEX_MEM_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=ue();return(0,w.existsSync)(r),r}var xt=Dt();function kt(){return(0,h.join)(xt,vt)}var fe=kt(),_s=(0,h.join)(M,"vector-db"),us=(0,h.join)(M,"observer-sessions"),ms=(0,h.join)(K,"settings.json"),ls=(0,h.join)(K,"commands"),Es=(0,h.join)(K,"CLAUDE.md");function Se(r){(0,w.mkdirSync)(r,{recursive:!0})}function he(){return(0,h.join)(Lt,"..")}var P=class{db;constructor(e=fe){e!==":memory:"&&Se((0,Oe.dirname)(e)),this.db=new be.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="date_asc"?"ASC":"DESC",u=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),g=[...e],E=[];if(o&&(E.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");E.push(`type IN (${l})`),g.push(...i)}else E.push("type = ?"),g.push(i);if(a){let l=Array.isArray(a)?a:[a],S=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...l),E.push(`(${S.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],S=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(f=>{g.push(`%${f}%`,`%${f}%`)}),E.push(`(${S.join(" OR ")})`)}let T=E.length>0?`WHERE id IN (${m}) AND ${E.join(" AND ")}`:`WHERE id IN (${m})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${T}
    ...
    `).all(...c)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let l=`
      ...
      `,S=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(l).all(e,...a,s+1),C=this.db.prepare(S).all(e,...a,n+1);if(f.length===0&&C.length===0)return{observations:[],sessions:[],prompts:[]};d=f.length>0?f[f.length-1].created_at_epoch:t,c=C.length>0?C[C.length-1].created_at_epoch:t}catch(f){return _.error("DB","Error getting boundary observations",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let l=`
      ...
      `,S=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let f=this.db.prepare(l).all(t,...a,s),C=this.db.prepare(S).all(t,...a,n+1);if(f.length===0&&C.length===0)return{observations:[],sessions:[],prompts:[]};d=f.length>0?f[f.length-1].created_at_epoch:t,c=C.length>0?C[C.length-1].created_at_epoch:t}catch(f){return _.error("DB","Error getting boundary timestamps",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}let u=`
      SELECT *
      FROM observations
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,...s,...o,t.totalObservationCount)}function ee(r,e,t){return r.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch
    FROM session_summaries
    WHERE project = ?
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+J)}function ye(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Ie(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+J)}function wt(r){return r.replace(/\//g,"-")}function Pt(r){try{if(!(0,X.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,X.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),a){s=a;break}}}catch(o){_.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return _.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function te(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=wt(s),a=Me.default.join((0,Ne.homedir)(),".claude","projects",i,`${o}.jsonl`);return Pt(a)}function Le(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function se(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function ve(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function De(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function xe(r){return[`# [${r}] recent context, ${De()}`,""]}function ke(){return[`**Legend:** session-request | ${O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ")}`,""]}function Ue(){return["**Column Key**:","- **Read**: Tokens to read this observation (cost to learn it now)","- **Work**: Tokens spent on work that produced this record ( research, building, deciding)",""]}function $e(){return["**Context Index:** This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.","","When you need implementation details, rationale, or debugging context:","- Use MCP tools (search, get_observations) to fetch full observations on-demand","- Critical types ( bugfix, decision) often need detailed fetching","- Trust this index over re-reading code for past decisions and learnings",""]}function we(r,e){let t=[];if(t.push("**Context Economics**:"),t.push(`- Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)`),t.push(`- Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="- Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(s)}return t.push(""),t}function Pe(r){return[`### ${r}`,""]}function Fe(r){return[`**${r}**`,"| ID | Time | T | Title | Read | Work |","|----|------|---|-------|------|------|"]}function je(r,e,t){let s=r.title||"Untitled",n=O.getInstance().getTypeIcon(r.type),{readTokens:o,discoveryDisplay:i}=I(r,t),a=t.showReadTokens?`~${o}`:"",d=t.showWorkTokens?i:"";return`| #${r.id} | ${e||'"'} | ${n} | ${s} | ${a} | ${d} |`}function Xe(r,e,t,s){let n=[],o=r.title||"Untitled",i=O.getInstance().getTypeIcon(r.type),{readTokens:a,discoveryDisplay:d}=I(r,s);n.push(`**#${r.id}** ${e||'"'} ${i} **${o}**`),t&&(n.push(""),n.push(t),n.push(""));let c=[];return s.showReadTokens&&c.push(`Read: ~${a}`),s.showWorkTokens&&c.push(`Work: ${d}`),c.length>0&&n.push(c.join(", ")),n.push(""),n}function Be(r,e){let t=`${r.request||"Session started"} (${e})`;return[`**#S${r.id}** ${t}`,""]}function v(r,e){return e?[`**${r}**: ${e}`,""]:[]}function He(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Ge(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use MCP search tools to access memories by ID.`]}function We(r){return`# [${r}] recent context, ${De()}

No previous sessions found for this project yet.`}function Ye(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Ve(r){return["",`${p.bright}${p.cyan}[${r}] recent context, ${Ye()}${p.reset}`,`${p.gray}${"\u2500".repeat(60)}${p.reset}`,""]}function Ke(){let e=O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${p.dim}Legend: session-request | ${e}${p.reset}`,""]}function qe(){return[`${p.bright}Column Key${p.reset}`,`${p.dim}  Read: Tokens to read this observation (cost to learn it now)${p.reset}`,`${p.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${p.reset}`,""]}function Je(){return[`${p.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${p.reset}`,"",`${p.dim}When you need implementation details, rationale, or debugging context:${p.reset}`,`${p.dim}  - Use MCP tools (search, get_observations) to fetch full observations on-demand${p.reset}`,`${p.dim}  - Critical types ( bugfix, decision) often need detailed fetching${p.reset}`,`${p.dim}  - Trust this index over re-reading code for past decisions and learnings${p.reset}`,""]}function ze(r,e){let t=[];if(t.push(`${p.bright}${p.cyan}Context Economics${p.reset}`),t.push(`${p.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${p.reset}`),t.push(`${p.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${p.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${p.green}${s}${p.reset}`)}return t.push(""),t}function Qe(r){return[`${p.bright}${p.cyan}${r}${p.reset}`,""]}function Ze(r){return[`${p.dim}${r}${p.reset}`]}function et(r,e,t,s){let n=r.title||"Untitled",o=O.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=I(r,s),c=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),u=s.showReadTokens&&i>0?`${p.dim}(~${i}t)${p.reset}`:"",m=s.showWorkTokens&&a>0?`${p.dim}(${d} ${a.toLocaleString()}t)${p.reset}`:"";return`  ${p.dim}#${r.id}${p.reset}  ${c}  ${o}  ${n} ${u} ${m}`}function tt(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=O.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:u}=I(r,n),m=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),g=n.showReadTokens&&d>0?`${p.dim}(~${d}t)${p.reset}`:"",E=n.showWorkTokens&&c>0?`${p.dim}(${u} ${c.toLocaleString()}t)${p.reset}`:"";return o.push(`  ${p.dim}#${r.id}${p.reset}  ${m}  ${a}  ${p.bright}${i}${p.reset}`),s&&o.push(`    ${p.dim}${s}${p.reset}`),(g||E)&&o.push(`    ${g} ${E}`),o.push(""),o}function st(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${p.yellow}#S${r.id}${p.reset} ${t}`,""]}function D(r,e,t){return e?[`${t}${r}:${p.reset} ${e}`,""]:[]}function rt(r){return r.assistantMessage?["","---","",`${p.bright}${p.magenta}Previously${p.reset}`,"",`${p.dim}A: ${r.assistantMessage}${p.reset}`,""]:[]}function nt(r,e){let t=Math.round(r/1e3);return["",`${p.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use MCP search tools to access memories by ID.${p.reset}`]}function ot(r){return`
${p.bright}${p.cyan}[${r}] recent context, ${Ye()}${p.reset}
${p.gray}${"\u2500".repeat(60)}${p.reset}

${p.dim}No previous sessions found for this project yet.${p.reset}
`}function it(r,e,t,s){let n=[];return s?n.push(...Ve(r)):n.push(...xe(r)),s?n.push(...Ke()):n.push(...ke()),s?n.push(...qe()):n.push(...Ue()),s?n.push(...Je()):n.push(...$e()),j(t)&&(s?n.push(...ze(e,t)):n.push(...we(e,t))),n}var re=k(require("path"),1);function G(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function dt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ct(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function at(r,e){return re.default.isAbsolute(r)?re.default.relative(e,r):r}function _t(r,e,t){let s=G(r);if(s.length>0)return at(s[0],e);if(t){let n=G(t);if(n.length>0)return at(n[0],e)}return"General"}function Ft(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ct(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function jt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?G(r.facts).join(`
`):null}function Xt(r,e,t,s,n,o){let i=[];o?i.push(...Qe(r)):i.push(...Pe(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let m=u.data,g=dt(m.displayTime);o?i.push(...st(m,g)):i.push(...Be(m,g))}else{let m=u.data,g=_t(m.files_modified,n,m.files_read),E=pt(m.created_at),T=E!==d,b=T?E:"";d=E;let l=t.has(m.id);if(g!==a&&(c&&i.push(""),o?i.push(...Ze(g)):i.push(...Fe(g)),a=g,c=!0),l){let S=jt(m,s);o?i.push(...tt(m,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...Xe(m,b,S,s)),a=null)}else o?i.push(et(m,E,T,s)):i.push(je(m,b,s))}return c&&i.push(""),i}function ut(r,e,t,s,n){let o=[],i=Ft(r);for(let[a,d]of i)o.push(...Xt(a,d,e,t,s,n));return o}function mt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function lt(r,e){let t=[];return e?(t.push(...D("Investigated",r.investigated,p.blue)),t.push(...D("Learned",r.learned,p.yellow)),t.push(...D("Completed",r.completed,p.green)),t.push(...D("Next Steps",r.next_steps,p.magenta))):(t.push(...v("Investigated",r.investigated)),t.push(...v("Learned",r.learned)),t.push(...v("Completed",r.completed)),t.push(...v("Next Steps",r.next_steps))),t}function Et(r,e){return e?rt(r):He(r)}function gt(r,e,t){return!j(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?nt(r.totalDiscoveryTokens,r.totalReadTokens):Ge(r.totalDiscoveryTokens,r.totalReadTokens)}var Bt=Tt.default.join((0,ft.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ht(){try{return new P}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,St.unlinkSync)(Bt)}catch(e){_.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return _.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Gt(r,e){return e?ot(r):We(r)}function Wt(r,e,t,s,n,o,i){let a=[],d=Q(e);a.push(...it(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Le(c,t),m=se(e,u),g=ve(e,s.fullObservationCount);a.push(...ut(m,g,s,n,i));let E=t[0],T=e[0];mt(s,E,T)&&a.push(...lt(E,i));let b=te(e,s,o,n);return a.push(...Et(b,i)),a.push(...gt(d,s,i)),a.join(`
`).trimEnd()}async function ne(r,e=!1){let t=q(),s=r?.cwd??process.cwd(),n=Ae(s),o=r?.projects||[n],i=Ht();if(!i)return"";try{let a=o.length>1?ye(i,o,t):Z(i,n,t),d=o.length>1?Ie(i,o,t):ee(i,n,t);return a.length===0&&d.length===0?Gt(n,e):Wt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
