"use strict";var Tt=Object.create;var U=Object.defineProperty;var ft=Object.getOwnPropertyDescriptor;var St=Object.getOwnPropertyNames;var ht=Object.getPrototypeOf,bt=Object.prototype.hasOwnProperty;var Ot=(r,e)=>{for(var t in e)U(r,t,{get:e[t],enumerable:!0})},de=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of St(e))!bt.call(r,n)&&n!==t&&U(r,n,{get:()=>e[n],enumerable:!(s=ft(e,n))||s.enumerable});return r};var $=(r,e,t)=>(t=r!=null?Tt(ht(r)):{},de(e||!r||!r.__esModule?U(t,"default",{value:r,enumerable:!0}):t,r)),Ct=r=>de(U({},"__esModule",{value:!0}),r);var Ht={};Ot(Ht,{generateContext:()=>ae});module.exports=Ct(Ht);var lt=$(require("path"),1),Et=require("os"),gt=require("fs");var Se=require("bun:sqlite");var h=require("path"),me=require("os"),v=require("fs");var le=require("url");var N=require("fs"),_e=require("path");var pe="bugfix,feature,refactor,discovery,decision,change",ce="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var Y=require("fs"),V=require("os"),q=require("path"),M="codex-mem",w="claude-mem",At=".codex-mem",Rt=".claude-mem";function Nt(){return(0,q.join)((0,V.homedir)(),At)}function Mt(){return(0,q.join)((0,V.homedir)(),Rt)}function P(){if(process.env.CODEX_MEM_DATA_DIR)return process.env.CODEX_MEM_DATA_DIR;if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=Nt();if((0,Y.existsSync)(r))return r;let e=Mt();return(0,Y.existsSync)(e)?e:r}var I=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_PROVIDER:"codex",CLAUDE_MEM_PROVIDER_FALLBACK_POLICY:"auto",CLAUDE_MEM_CODEX_MODEL:"gpt-5",CLAUDE_MEM_CODEX_REASONING_EFFORT:"high",CLAUDE_MEM_CLAUDE_AUTH_METHOD:"cli",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:M,CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_OLLAMA_MODE:"native",CLAUDE_MEM_OLLAMA_BASE_URL:"http://127.0.0.1:11434",CLAUDE_MEM_OLLAMA_MODEL:"gemma3:4b",CLAUDE_MEM_OLLAMA_TIMEOUT_MS:"120000",CLAUDE_MEM_OLLAMA_TEMPERATURE:"0.2",CLAUDE_MEM_OLLAMA_NUM_CTX:"8192",CLAUDE_MEM_OLLAMA_OPTIONS_JSON:"{}",CLAUDE_MEM_DATA_DIR:P(),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:pe,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:ce,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,N.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,_e.dirname)(e);(0,N.existsSync)(a)||(0,N.mkdirSync)(a,{recursive:!0}),(0,N.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return this.applyEnvironmentOverrides(i)}let t=(0,N.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,N.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))n[i]!==void 0&&(o[i]=n[i]);return this.applyEnvironmentOverrides(o)}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.applyEnvironmentOverrides(this.getAllDefaults())}}static applyEnvironmentOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS)){let n=process.env[s];if(n!==void 0&&(t[s]=n),s.startsWith("CLAUDE_MEM_")){let o=`CODEX_MEM_${s.slice(11)}`,i=process.env[o];i!==void 0&&(t[s]=i)}}return process.env.CODEX_CODE_PATH&&!process.env.CLAUDE_CODE_PATH&&(t.CLAUDE_CODE_PATH=process.env.CODEX_CODE_PATH),t}};var R=require("fs"),L=require("path");var K=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(K||{}),ue=P(),J=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,L.join)(ue,"logs");(0,R.existsSync)(e)||(0,R.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0],s=(0,L.join)(e,`${M}-${t}.log`),n=(0,L.join)(e,`${w}-${t}.log`);this.logFilePath=(0,R.existsSync)(s)?s:(0,R.existsSync)(n)?n:s}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,L.join)(ue,"settings.json");if((0,R.existsSync)(e)){let t=(0,R.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=K[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:b,...l}=n;Object.keys(l).length>0&&(m=` {${Object.entries(l).map(([f,A])=>`${f}=${A}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${m}${u}`;if(this.logFilePath)try{(0,R.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},_=new J;var xt={};function It(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,le.fileURLToPath)(xt.url))}var yt=It(),C=I.get("CLAUDE_MEM_DATA_DIR"),z=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,me.homedir)(),".claude"),ns=(0,h.join)(C,"archives"),os=(0,h.join)(C,"logs"),is=(0,h.join)(C,"trash"),as=(0,h.join)(C,"backups"),ds=(0,h.join)(C,"modes"),Ee=(0,h.join)(C,"settings.json"),Lt=`${M}.db`,vt=`${w}.db`;function Dt(){let r=(0,h.join)(C,Lt);if((0,v.existsSync)(r))return r;let e=(0,h.join)(C,vt);return(0,v.existsSync)(e)?e:r}var ge=Dt(),ps=(0,h.join)(C,"vector-db"),cs=(0,h.join)(C,"observer-sessions"),_s=(0,h.join)(z,"settings.json"),us=(0,h.join)(z,"commands"),ms=(0,h.join)(z,"CLAUDE.md");function Te(r){(0,v.mkdirSync)(r,{recursive:!0})}function fe(){return(0,h.join)(yt,"..")}var F=class{db;constructor(e=ge){e!==":memory:"&&Te(C),this.db=new Se.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(...c)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let l=`
      ...
      `,S=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(l).all(e,...a,s+1),A=this.db.prepare(S).all(e,...a,n+1);if(f.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};d=f.length>0?f[f.length-1].created_at_epoch:t,c=A.length>0?A[A.length-1].created_at_epoch:t}catch(f){return _.error("DB","Error getting boundary observations",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let l=`
      ...
      `,S=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let f=this.db.prepare(l).all(t,...a,s),A=this.db.prepare(S).all(t,...a,n+1);if(f.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};d=f.length>0?f[f.length-1].created_at_epoch:t,c=A.length>0?A[A.length-1].created_at_epoch:t}catch(f){return _.error("DB","Error getting boundary timestamps",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}let u=`
      SELECT *
      FROM observations
...
`}function rt(r,e,t,s){let n=[];return s?n.push(...He(r)):n.push(...Le(r)),s?n.push(...We()):n.push(...ve()),s?n.push(...Ye()):n.push(...De()),s?n.push(...Ve()):n.push(...xe()),X(t)&&(s?n.push(...qe(e,t)):n.push(...ke(e,t))),n}var ie=$(require("path"),1);function W(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ot(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function at(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function nt(r,e){return ie.default.isAbsolute(r)?ie.default.relative(e,r):r}function dt(r,e,t){let s=W(r);if(s.length>0)return nt(s[0],e);if(t){let n=W(t);if(n.length>0)return nt(n[0],e)}return"General"}function wt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=at(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Pt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?W(r.facts).join(`
`):null}function Ft(r,e,t,s,n,o){let i=[];o?i.push(...Ke(r)):i.push(...Ue(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let m=u.data,g=ot(m.displayTime);o?i.push(...Ze(m,g)):i.push(...Fe(m,g))}else{let m=u.data,g=dt(m.files_modified,n,m.files_read),E=it(m.created_at),T=E!==d,b=T?E:"";d=E;let l=t.has(m.id);if(g!==a&&(c&&i.push(""),o?i.push(...Je(g)):i.push(...$e(g)),a=g,c=!0),l){let S=Pt(m,s);o?i.push(...Qe(m,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...Pe(m,b,S,s)),a=null)}else o?i.push(ze(m,E,T,s)):i.push(we(m,b,s))}return c&&i.push(""),i}function pt(r,e,t,s,n){let o=[],i=wt(r);for(let[a,d]of i)o.push(...Ft(a,d,e,t,s,n));return o}function ct(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function _t(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,p.blue)),t.push(...k("Learned",r.learned,p.yellow)),t.push(...k("Completed",r.completed,p.green)),t.push(...k("Next Steps",r.next_steps,p.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function ut(r,e){return e?et(r):je(r)}function mt(r,e,t){return!X(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?tt(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}var jt=lt.default.join((0,Et.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Xt(){try{return new F}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,gt.unlinkSync)(jt)}catch(e){_.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return _.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Bt(r,e){return e?st(r):Be(r)}function Gt(r,e,t,s,n,o,i){let a=[],d=te(e);a.push(...rt(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Me(c,t),m=oe(e,u),g=Ie(e,s.fullObservationCount);a.push(...pt(m,g,s,n,i));let E=t[0],T=e[0];ct(s,E,T)&&a.push(..._t(E,i));let b=ne(e,s,o,n);return a.push(...ut(b,i)),a.push(...mt(d,s,i)),a.join(`
`).trimEnd()}async function ae(r,e=!1){let t=Q(),s=r?.cwd??process.cwd(),n=be(s),o=r?.projects||[n],i=Xt();if(!i)return"";try{let a=o.length>1?Re(i,o,t):se(i,n,t),d=o.length>1?Ne(i,o,t):re(i,n,t);return a.length===0&&d.length===0?Bt(n,e):Gt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
