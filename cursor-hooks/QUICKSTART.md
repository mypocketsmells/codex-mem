...
codex-mem settings set CLAUDE_MEM_PROVIDER gemini
codex-mem settings set CLAUDE_MEM_GEMINI_API_KEY your-api-key

# Option B: OpenRouter (free models available)
codex-mem settings set CLAUDE_MEM_PROVIDER openrouter
codex-mem settings set CLAUDE_MEM_OPENROUTER_API_KEY your-api-key
```
